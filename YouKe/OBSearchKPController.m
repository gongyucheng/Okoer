...
@interface OBSearchKPController ()<BaseTableViewDelegate>
{
    MBProgressHUD *_hud;
    NSInteger page;
}
...
@implementation OBSearchKPController
...
- (void)loadDataWithSearchString:(NSString *)searchString
{
    ...
    NSString *urlString = OBKPURL;
    if ([OBAccountTool account]) {
        urlString = OBSearchKPURL(uid, timeString, sign);
    }
...
- (void)didReceiveMemoryWarning {
    NSLog(@"OBSearchKPControllerdidReceiveMemoryWarning");
